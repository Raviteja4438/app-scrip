    ...
    <section className='footer-container'>
        ...
        <div className='footer-lg-first-part'>
            ...
            <div>
                ...
                <div className='footer-usa-container'>
                    <img src= "https://res.cloudinary.com/dlngyh6jo/image/upload/v1713782565/United_States_of_America_US_e2ol6g.png" alt="footer-usa-logo" />
                    <h3> . USD</h3>
                </div>
        ...
        <div className='footer-lg-first-part'>
            ...
            <div>
                ...
                <img src="https://res.cloudinary.com/dlngyh6jo/image/upload/v1713782669/Frame_136278_scvx2o.png" alt="cards" />
            </div>
        </div>
        <div>
        ...
        <div className="footer-for-md-divices">
            ...
            <div>
                <h3>metta muse ACCEPTS</h3>
                <img src="https://res.cloudinary.com/dlngyh6jo/image/upload/v1713782669/Frame_136278_scvx2o.png" alt="cards" className="cards-image" />
            </div>
            <div>
            <div className="copyright-container">
                <p>Copyright</p>
